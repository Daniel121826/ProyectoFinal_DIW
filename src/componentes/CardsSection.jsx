      ...
      <div className="w-[90%] mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card
            ...
            image={smallImage1}
          >
            <p className="text-gray-700 text-sm mt-1">Crea diseños profesionales y atractivos para tus campañas y redes sociales.</p>
          </Card>
          ...
          <Card
            ...
            image={smallImage2}
          >
            <p className="text-gray-700 text-sm mt-1">Optimiza tu presencia online y llega a tu público objetivo de manera efectiva.</p>
          </Card>
          ...
          <Card
            ...
            image={smallImage3}
          >
            <p className="text-gray-700 text-sm mt-1">Diseña y desarrolla páginas web modernas, responsivas y optimizadas.</p>
          </Card>
          ...
          <Card
            ...
            image={smallImage4}
          >
            <p className="text-gray-700 text-sm mt-1">Analiza el rendimiento de tu empresa y toma decisiones basadas en datos.</p>
          </Card>
        </div>
