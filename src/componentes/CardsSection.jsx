...
export default function CardsSection({ darkMode }) {
  return (
    <div
      className={
        darkMode
          ? "w-full py-20 bg-gray-900 text-center sm:text-start"
          : "w-full py-20 bg-gray-100 text-center sm:text-start"
      }
    >
      <div className="w-[90%] mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card title="Diseño Gráfico" image={smallImage1} darkMode={darkMode}>
          ...
          <Card title="Desarrollo Web" image={smallImage3} darkMode={darkMode}>
            <p className="text-sm mt-1">
